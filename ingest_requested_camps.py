...
REQUESTED_CAMPS = [
    ...
    },
    {
        ...
        "notes": "Dublin South booking page lists multiple weekly summer camps across venues; check event pages for exact week/location details.",
    },
    {
    ...
    {
        "name": "Wild By Nature Forest School Camp (Cabinteely)",
        "type": "Forest school and outdoor nature camp",
        "county": "Dublin",
        "locationDetail": "Cabinteely Park (Bray Road entrance), Dublin 18",
        "priceEur": None,
        ...
        "ageMin": None,
        "ageMax": None,
        "sourceUrl": "https://irishforestschoolassociation.ie/forest-schools-in-dublin/",
        "notes": "Listed by Irish Forest School Association for Cabinteely Park; check provider channels for current seasonal camp dates.",
    },
    {
